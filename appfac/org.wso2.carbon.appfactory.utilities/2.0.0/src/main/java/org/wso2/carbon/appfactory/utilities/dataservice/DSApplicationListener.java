...
public class DSApplicationListener extends ApplicationEventsHandler {
    ...
    public DSApplicationListener(String identifier, int priority) {
        ...
        try {
            ...
            String dbHost = appFactoryConfiguration.getFirstProperty(AppFactoryConstants.APP_TYPE + "." + AppFactoryConstants.APPLICATION_TYPE_DBS +
                    ".Property.SampleDbHostUrl");
            testUserName = appFactoryConfiguration.getFirstProperty(AppFactoryConstants.APP_TYPE + "." + AppFactoryConstants.APPLICATION_TYPE_DBS +
                    ".Property.SampleDbUser");
            testUserPw = appFactoryConfiguration.getFirstProperty(AppFactoryConstants.APP_TYPE + "." + AppFactoryConstants.APPLICATION_TYPE_DBS +
                    ".Property.SampleDbUserPassword");
            String sampleDbName = appFactoryConfiguration.getFirstProperty(AppFactoryConstants.APP_TYPE + "." + AppFactoryConstants.APPLICATION_TYPE_DBS +
                    ".Property.SampleDbName");
            sampleDSName = appFactoryConfiguration.getFirstProperty(AppFactoryConstants.APP_TYPE + "." + AppFactoryConstants.APPLICATION_TYPE_DBS +
                    ".Property.SampleDatasourceName");
    ...
    private void createSampleDataSource(Application application) throws AppFactoryException {
        ...
        for (String stage : stages) {
            ...
            try {
	            ...
	            authorizationMgtClient.setMutualAuthHeader(tenantUserName);
                ...
                AppFactoryUtil.setMutualAuthHeader(client, tenantUserName);
