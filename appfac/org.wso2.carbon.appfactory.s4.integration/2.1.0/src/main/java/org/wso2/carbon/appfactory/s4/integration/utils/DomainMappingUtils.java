...
public class DomainMappingUtils {
    ...
    private final static RxtManager rxtManager = new RxtManager();
    ...
    public static void updateVersionMetadataWithMappedDomain(String appKey, String version, String mappedDomain)
        ...
        try {
            rxtManager.updateAppVersionRxt(appKey, version, AppFactoryConstants.RXT_KEY_APPVERSION_PROD_MAPPED_VERSION,
                                           getSubDomain(mappedDomain), tenantDomain);
     ...
     */
    public static String getDomainAvailableEndPoint(String stage, String domain) {
        return String.format(DOMAIN_AVAILABLE_END_POINT, getCartridgeType(stage), getSubscriptionAlias(stage), domain);
    }
     ...
     */
    public static String getAddDomainEndPoint(String stage) {
        return String.format(ADD_DOMAIN_END_POINT, getCartridgeType(stage), getSubscriptionAlias(stage));
    }
     ...
     */
    public static String getRemoveDomainEndPoint(String stage, String domain) {
        return String.format(REMOVE_DOMAIN_END_POINT, getCartridgeType(stage), getSubscriptionAlias(stage), domain);
    }
