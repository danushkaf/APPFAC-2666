...
public class ResourceManager {
    ...
    /**
     * Check whether the database is exist
     *
     * @param dbName        database name
     * @param applicationId application id
     * @param environment   environment
     * @return true if database is exist
     * @throws AppFactoryException
     */
    public static boolean isDatabaseExist(final String dbName, final String applicationId,
        ...
        return resourceDAO.isResourceExists(applicationId, dbName, DATABASE_RESOURCE, environment);
    }
