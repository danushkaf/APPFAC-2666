...
public class RxtManager {
    ...
    public void updateAppVersionForUserRxt(String applicationId, String version, String userName, String key[],
        ...
        synchronized (tenant_appLock.intern()){
            ...
            log.info("=============== updating forked user rxt =============== key:" + key + " value:" + newValue);
            if (artifact == null) {
                String errorMsg =
                        String.format("Unable to find appversion information for id : %s",
                                applicationId);
...
//    TODO:should not be used. check and remove.
    ...
    public List<Artifact> getRepoUserRxtForApplicationOfUser(String domainName, String applicationId, String userName)
        ...
        return getrepoUserRXTFromRegistry(userRegistry, applicationId, userName.split("@")[0]);
    }
     ...
     * @throws RegistryException
     */
    private List<Artifact> getrepoUserRXTFromRegistry(UserRegistry userRegistry,final String applicationId, final String userName) throws  AppFactoryException,
            RegistryException  {
        GovernanceUtils.loadGovernanceArtifacts(userRegistry);
        GenericArtifactManager artifactManager =
                new GenericArtifactManager(userRegistry,
        ...
        if(allArtifacts != null){
            for (GenericArtifact genericArtifact : allArtifacts) {
                artifactList.add(getRepoUserArtifactByGenericArtifact(genericArtifact));
            }
...
//        }
    ...
    private Artifact getArtifactByGenericArtifact(GenericArtifact paramGenericArtifact)
        ...
        String promoteStatus = paramGenericArtifact.getAttribute("appversion_PromoteStatus");
     ...
     * @throws GovernanceException
     */
    private Artifact getRepoUserArtifactByGenericArtifact(GenericArtifact paramGenericArtifact)
            throws GovernanceException {
        ...
        String lastBuildStatus = paramGenericArtifact.getAttribute("repouser_LastBuildStatus");
        String currentBuildStatus = paramGenericArtifact.getAttribute("repouser_CurrentBuildStatus");
        String lastDeployedId = paramGenericArtifact.getAttribute("repouser_lastdeployedid");
