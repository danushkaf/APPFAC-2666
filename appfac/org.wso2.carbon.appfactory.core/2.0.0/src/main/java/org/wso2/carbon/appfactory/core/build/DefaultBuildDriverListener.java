...
public class DefaultBuildDriverListener implements BuildDriverListener {
    ...
    public void onBuildSuccessful(String applicationId, String version, String revision,String userName, String repoFrom, String buildId,
        ...
        updateLastBuildStatus(applicationId, version,  "build " + buildId + " " + SUCCESS,userName, repoFrom, tenantDomain);
    ...
    public void onBuildFailure(String applicationId, String version, String revision,String userName, String repoFrom, String buildId,
        ...
        updateLastBuildStatus(applicationId, version,"build " + buildId + " " + FAILED, userName, repoFrom,tenantDomain);
        //updateCurrentBuildStatus(applicationId, version, "", tenantDomain);
     ...
     */
    public static void updateLastBuildStatus(String applicationId, String version, String result, String userName, String repoFrom, String tenantDomain) {
        try {
            ...
            if(repoFrom.equals(AppFactoryConstants.ORIGINAL_REPOSITORY)){
            	...
            	String []key = {"repouser_"+LAST_BUILD_STATUS_KEY,"repouser_"+CURRENT_BUILD_STATUS_KEY};
                String []values = {result , "finished"};
            	rxtManager.updateAppVersionForUserRxt(applicationId, version, userName, key, values, tenantDomain);
            }
