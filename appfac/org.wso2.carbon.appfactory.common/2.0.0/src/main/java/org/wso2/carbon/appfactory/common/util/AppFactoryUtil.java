...
public class AppFactoryUtil {
	...
	public static boolean isFreestyleNonBuilableProject(String applicationType) throws AppFactoryException {
		String appTypeBuildJobTemplateElementKey =
		                                    AppFactoryConstants.APP_TYPE + "." + applicationType +
		                                            ".Property.BuildJobTemplate";
		String isAppFreeStyle = appFactoryConfig.getFirstProperty(appTypeBuildJobTemplateElementKey);
    ...
    public static boolean isUplodableAppType(String type) throws AppFactoryException{
    	 return  Boolean.parseBoolean(getAppfactoryConfiguration().getFirstProperty("ApplicationType." + type +
                                                                         ".Property.isUploadableAppType"));
    }

    public static void setMutualAuthHeader(ServiceClient serviceClient, String username) throws AppFactoryException {
        ...
        try {
            ...
            serviceClient.addHeader(org.apache.axiom.om.impl.llom.util.AXIOMUtil.stringToOM(mutualAuthHeader));
            if(log.isDebugEnabled()){
                log.debug("Mutual auth header for service client:"+serviceClient.getTargetEPR() +" ,header:"+mutualAuthHeader);
            }
        } catch (XMLStreamException e) {
     ...
     * @throws org.wso2.carbon.appfactory.common.AppFactoryException if failed to get appfactory.xml configuration details.
     */
