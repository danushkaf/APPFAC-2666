...
public class IssueTrackerListener extends ApplicationEventsHandler {
    ...
    public void onCreation(Application application, String userName, String tenantDomain, boolean isUploadableAppType) throws AppFactoryException {
        ...
        try {
            String infoMessage = "Issue tracker space for " + application.getId() + "  completed.";
            String infoMsgDesc = "Issue tracker provisioning for application " + application.getId() + " is successfully completed.";
            EventNotifier.getInstance().notify(EventBuilderUtil.buildApplicationCreationEvent(infoMessage, infoMsgDesc, Event.Category.INFO));
