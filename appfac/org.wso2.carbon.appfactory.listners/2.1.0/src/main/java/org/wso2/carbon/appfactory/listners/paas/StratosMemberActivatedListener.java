...
public class StratosMemberActivatedListener {
    ...
    private static volatile StratosMemberActivatedListener stratosMemberActivatedListener;
     ...
     *
     * @return {@link org.wso2.carbon.appfactory.listners.paas.StratosMemberActivatedListener}
     */
    public static StratosMemberActivatedListener getInstance() {
        if (stratosMemberActivatedListener == null) {
            synchronized (StratosMemberActivatedListener.class) {
                if (stratosMemberActivatedListener == null) {
                    stratosMemberActivatedListener = new StratosMemberActivatedListener();
                }
            }
        }
