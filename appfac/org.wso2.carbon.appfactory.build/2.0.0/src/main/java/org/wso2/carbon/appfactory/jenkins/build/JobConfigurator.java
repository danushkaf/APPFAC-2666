...
public class JobConfigurator {
    ...
    private OMElement getJenkinFreeStyleJobConfigurationTemplate(String projectType) throws AppFactoryException {
        ...
        } else if (AppFactoryConstants.FILE_TYPE_UPLOADED_WAR.equals(projectType)){
        	setValueUsingXpath(jobConfigTemplate,JenkinsCIConstants.ARTIFACT_ARCHIVER_CONFIG_NAME_XAPTH_SELECTOR,"*.war");
        ...
        }else if(AppFactoryConstants.FILE_TYPE_UPLOADED_JAGGERY.equals(projectType)){
        	setValueUsingXpath(jobConfigTemplate,JenkinsCIConstants.ARTIFACT_ARCHIVER_CONFIG_NAME_XAPTH_SELECTOR,"*.zip");
        	String repositoryBranchName = parameters.get(JenkinsCIConstants.APPLICATION_VERSION);
        	if(AppFactoryConstants.INITIAL_UPLOADED_APP_VERSION.equals(repositoryBranchName)){
        		setValueUsingXpath(jobConfigTemplate,"/*/scm/branches/hudson.plugins.git.BranchSpec/name","**");
        	}
