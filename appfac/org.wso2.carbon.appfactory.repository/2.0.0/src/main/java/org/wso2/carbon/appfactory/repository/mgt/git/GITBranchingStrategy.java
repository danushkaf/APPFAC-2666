...
public class GITBranchingStrategy implements BranchingStrategy {
    ...
    public void prepareRepository(String applicationKey, String url, String tenantDomain) throws RepositoryMgtException {
		...
		try {
			...
			log.error(
					"Error creating work directory at location" + workDir.getAbsolutePath(), e);
		}
    ...
    public void doRepositoryBranch(String appId, String currentVersion, String targetVersion,
        ...
        synchronized(lock.intern()) {
	        ...
	        try {
				...
				log.error("Error creating work directory at location" + workDir.getAbsolutePath(), e);
			}
	        ...
	        try {
				...
				applicationTypeProcessor.doVersion(appId, targetVersion, currentVersion, workDir.getAbsolutePath());
	        } catch (AppFactoryException e) {
	        ...
	        client.forceCheckIn(sourceURL, workDir, targetVersion, "Modified after the branching");
