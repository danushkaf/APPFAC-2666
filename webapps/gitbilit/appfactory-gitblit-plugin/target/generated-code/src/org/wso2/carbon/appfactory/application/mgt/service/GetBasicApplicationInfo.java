 ...
 */
            ...
            /**
            *  GetBasicApplicationInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetBasicApplicationInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBasicApplicationInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBasicApplicationInfo",
    ...
    public static class Factory{
        ...
        */
        public static GetBasicApplicationInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBasicApplicationInfo object =
                new GetBasicApplicationInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBasicApplicationInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBasicApplicationInfo)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
